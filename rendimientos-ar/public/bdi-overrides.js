  ...
  const COPY = {
    es: {
      ...
      selectors: {
        ...
        '.shortcut-card[href="#ars"] p': 'Tasas bancarias para una lectura rapida de liquidez en pesos.',
        ...
        '#optimizer-section .section-desc': 'Modelo de Markowitz para comparar frontera eficiente, portfolio de maximo Sharpe, minima volatilidad y un retorno objetivo opcional.',
        '#optimizer-frontier-section h2': 'Espacio de portfolios',
        '#optimizer-frontier-section .section-desc': 'Mapa riesgo-retorno con portfolios aleatorios, frontera eficiente y cartera de mercado implicita.',
        ...
        '#optimizer-performance-section .section-desc': 'Evolucion historica acumulada de activos y portfolios optimizados.',
        '#optimizer-analytics-section h2': 'Matriz y CAGR',
        '#optimizer-analytics-section .section-desc': 'Lectura de correlacion y CAGR anual para activos y portfolios resultantes.',
        '#heatmap-section h2': 'Heatmap USA',
        '#heatmap-section .section-desc': 'Mapa de mercado estilo Finviz con large caps de Estados Unidos, color por variación diaria y tamaño por market cap.',
        ...
        '.footer p:first-child': 'BDI Consultora, elaborado por Tomas Rodriguez.',
    ...
    en: {
      ...
      hero: {
        ...
        ars: {
          title: 'Peso liquidity',
          description: 'Yield accounts and liquidity funds to organize cash and compare short-term alternatives.',
      ...
      selectors: {
        ...
        '.shortcut-card[href="#ars"] p': 'Bank rates for a quick read on peso liquidity.',
        ...
        '#optimizer-section .section-desc': 'Markowitz model to compare the efficient frontier, max-Sharpe, minimum-volatility and optional target-return portfolios.',
        '#optimizer-frontier-section h2': 'Portfolio space',
        '#optimizer-frontier-section .section-desc': 'Risk-return map with random portfolios, efficient frontier and implied market portfolio.',
        ...
        '#optimizer-performance-section .section-desc': 'Historical cumulative performance of assets and optimized portfolios.',
        '#optimizer-analytics-section h2': 'Matrix and CAGR',
        '#optimizer-analytics-section .section-desc': 'Correlation and annual CAGR readout for assets and resulting portfolios.',
        '#heatmap-section h2': 'USA heatmap',
        '#heatmap-section .section-desc': 'Finviz-style market map with US large caps, color by daily move and size by market cap.',
        ...
        '.footer p:first-child': 'BDI Consultora, prepared by Tomas Rodriguez.',
